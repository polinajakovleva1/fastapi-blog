...
@router.get("/admin/categories", response_model=list[CategoryAdmin], dependencies=[Depends(require_admin)])
async def get_admin_categories(
    db: AsyncSession = Depends(get_db)
):
    return await get_categories_list(db)

@router.get("/admin/categories/{category_id}", response_model=CategoryAdmin, dependencies=[Depends(require_admin)])
...
@router.post("/admin/categories", response_model=CategoryAdmin, dependencies=[Depends(require_admin)])
...
@router.patch("/admin/categories/{category_id}", response_model=CategoryAdmin, dependencies=[Depends(require_admin)])
